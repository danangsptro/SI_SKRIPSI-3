...
@section('title', 'DATA | EDIT BARANG')
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" placeholder="Masukan nama customer" name="nama_barang"
                        ...
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" placeholder="Masukan nama barang"
                                    name="kode_barang" required  value="{{ $data->kode_barang }}">
                                @error('kode_barang')
                                    <div class="text-danger">{{ $message }}</div>
                                @enderror
                            </div>
