...
@section('title', 'DATA | EDIT SUPPLIER')
    ...
    <div class="container card-content">
        <div class="card shadow mb-4">
            ...
            <div class="container-fluid mt-4 mb-4">
                <form method="POST" action="{{route('update-supplier', $data->id)}}" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" placeholder="Masukan nama supplier" name="nama_supplier"
                                    required value="{{ $data->nama_supplier }}">
                                @error('nama_supplier')
                        ...
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" placeholder="Masukan kode supplier"
                                    name="kode_supplier" required  value="{{ $data->kode_supplier }}">
                                @error('kode_supplier')
                                    <div class="text-danger">{{ $message }}</div>
                                @enderror
                            </div>
